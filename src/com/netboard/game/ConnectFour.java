...
public static String[][] removelines(String[][] f)
{
	String[][] nolines = new String[6][7];
	
  for (int i =0;i<f.length-1;i++)
  {
    for (int j=0;j<f[i].length-8;j++)
    {
  	  nolines[i][j] = f[i][2*j+1];
    }
  }
...
public static void printnolines(String[][] f)
{
  for (int i =0;i<f.length;i++)
  {
    for (int j=0;j<f[i].length;j++)
